...
def account():
    ...
    return render_template("account.html",update_profile_pic_form=update_profile_pic_form,update_username_form=update_username_form,current_username=current_user.username,image=get_b64_img(current_user.username))
